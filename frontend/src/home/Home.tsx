...
export default function Home(): React.ReactElement {
  ...
  <section id="contact"><Contact theme={theme} /></section>
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', position: 'relative', zIndex: 1, padding: '0 1rem' }}>
          <div className="footer-grid" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '3rem', marginBottom: '3rem' }}>
            ...
            <div>
              ...
              <nav className="footer-nav" style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
          ...
          <div className="footer-bottom" style={fStyles.bottom(theme)}>
